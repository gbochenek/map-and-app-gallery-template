...
define([
    ...
    "dojo/dom-construct",
    "dojo/on"
], function (declare, lang, array, Deferred, dom, query, i18n, ioScript, domStyle, domGeom, number, esriRequest, config, arcgisUtils, GeometryService, urlUtils, esriPortal, commonConfig, Dialog, domAttr, domClass, domConstruct, on) {

    return declare(null, {
        queryOrganization: function () {
            var deferred, appLocation, instance, req;
        ...
        addSpinner: function (id) {
            ...
            html = '<span class="spinnerRemove"><span class="loadingAjax"></span></span>';
            node = dom.byId(id);
        ...
        isMobileUser: function () {
            // if ios or android
            return (this._options.agent_ios || this._options.agent_android);
        },
        /*------------------------------------*/
        // Set user agent
        /*------------------------------------*/
        ...
        insertSocialHTML: function () {
            ...
            if (this._options.showSocialButtons) {
                ...
                html += '</div>';
                // addthis url
                addthisURL = "http://s7.addthis.com/js/250/addthis_widget.js#pubid=";
                // https support
        ...
        insertHeaderContent: function () {
            var html = '', node, topHeader;

            node = dom.byId('templateNav');
        ...
        createPagination: function (obj, totalItems, pagObject) {
            ...
            // variables
            var html = '', startHTML = '', middleHTML = '', endHTML = '',
                current, first, previous, next, last, middleCount = 0,
                lastMiddle = 0, firstMiddle = 0, remainderStart,
                helipText = i18n.viewer.pagination.helip,
        ...
        getViewerURL: function (viewer, webmap, owner) {
            ...
            for (key in this.urlObject.query) {
                // if url has property
